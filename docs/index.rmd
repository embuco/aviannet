...
```{r, child ="_header.rmd"}
```
# 2018 Day of Civic Hacking Project 
## When: Sat. 11 Aug
## Where: __TBD__
...
_The second goal is to set up an functioning process to filter images for us based on the training create from the first goal._
